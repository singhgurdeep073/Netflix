...
import 'package:netflix/apis/Category/category.dart';
import 'package:netflix/apis/Category/product.dart';
import 'package:netflix/apis/Slider/slidercat.dart';
...
import 'login&reg/pageview.dart';
...
Future<void>main()async{
  ...
  runApp(MaterialApp(
    ...
    home: email==null?Splesh_screen():bottom(),
  ));
}
/*void main() {
  runApp(const MyApp());
